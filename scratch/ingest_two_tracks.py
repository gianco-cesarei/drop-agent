#!/usr/bin/env python3
"""
Direct Ingestion Script for:
1. Roberto Manolio - Machine City Road (from Bosco054)
2. Data Memory Access - Controller (from BoscoLP05)
"""
...
TRACKS = [
    {
        "url": "https://bosconirecords.bandcamp.com/track/machine-city-road",
        "artist": "Roberto Manolio",
        "title": "Machine City Road",
        "album": "[Bosco054] Manolio / Angeloro - Tangled Waves",
        "year": "2025",
        "label": "Bosconi Records",
        "genre": "Underground / Tech House / Electro"
    },
    {
        "url": "https://bosconirecords.bandcamp.com/track/controller",
        "artist": "Data Memory Access",
        "title": "Controller",
        "album": "[BoscoLP05] Bosconi Stallions Vol.III",
        "year": "2023",
        "label": "Bosconi Records",
        "genre": "Underground / Deep Tech / Minimal"
    }
]
...
def download_track(track_info):
    ...
    if bpm <= 119:
        ...
        # Check if it has peak energy or groove
        phase_prefix = "[3]"
    ...
    print(f"✅ Posizionato con successo in:\n   {target_file}\n")
    return str(target_file)

if __name__ == "__main__":
    results = []
    for t in TRACKS:
        res = download_track(t)
        results.append(res)
